...
const PHASES: Phase[] = [
  {
    ...
    items: [
      ...
      { id: 'p0-4', label: 'Privacy Policy hosted at a real URL' },
    ],
  },
  {
    id: 'p1',
    ...
    items: [
      ...
      { id: 'p1-4', label: 'Splash screen designed (1284×2778 px safe zone)' },
      { id: 'p1-5', label: 'Splash screen wired into app.json' },
